...
public class ClientServiceUnitTests
{
    ...
    {
        var client = new Client(Guid.NewGuid(), "John Doe", "Male", DateOnly.FromDateTime(DateTime.Today), Guid.NewGuid(), DateOnly.FromDateTime(DateTime.Today), 10, new List<Tuple<DateOnly, DateOnly>>());
    ...
    public async Task DeleteClient_ShouldCallDeleteClientAsync_WhenClientExists()
    {
        ...
        _mockClientRepository.Setup(r => r.GetClientByIdAsync(clientId)).ReturnsAsync(new Client(clientId, "John Doe", "Male", DateOnly.FromDateTime(DateTime.Today), Guid.NewGuid(), DateOnly.FromDateTime(DateTime.Today), 10, new List<Tuple<DateOnly, DateOnly>>()));
    ...
    {
        var clientId = Guid.NewGuid();
        var client = new Client(clientId, "John Doe", "Male", DateOnly.FromDateTime(DateTime.Today), Guid.NewGuid(), DateOnly.FromDateTime(DateTime.Today), 10, new List<Tuple<DateOnly, DateOnly>>());
    ...
    public async Task GetClients_ShouldReturnListOfClients_WithLimitAndOffset()
    {
        ...
        {
            new Client(Guid.NewGuid(), "John Doe", "Male", DateOnly.FromDateTime(DateTime.Today), Guid.NewGuid(), DateOnly.FromDateTime(DateTime.Today), 10, new List<Tuple<DateOnly, DateOnly>>()),
            new Client(Guid.NewGuid(), "Jane Smith", "Female", DateOnly.FromDateTime(DateTime.Today), Guid.NewGuid(), DateOnly.FromDateTime(DateTime.Today), 8, new List<Tuple<DateOnly, DateOnly>>()),
            new Client(Guid.NewGuid(), "Alex Johnson", "Male", DateOnly.FromDateTime(DateTime.Today), Guid.NewGuid(), DateOnly.FromDateTime(DateTime.Today), 12, new List<Tuple<DateOnly, DateOnly>>())
        };
    ...
    {
        var clientId = Guid.NewGuid();
        var client = new Client(clientId, "John Doe", "Male", DateOnly.FromDateTime(DateTime.Today), Guid.NewGuid(), DateOnly.FromDateTime(DateTime.Today), 5, new List<Tuple<DateOnly, DateOnly>>());
        var freezingStart = DateOnly.FromDateTime(DateTime.Now);
