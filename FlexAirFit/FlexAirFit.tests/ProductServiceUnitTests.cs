...
namespace FlexAirFit.Tests
{
    public class ProductServiceUnitTests
    {
        ...
        {
            var product = new Product(Guid.NewGuid(), "SampleType", "Sample Product", 100);
        ...
        public async Task DeleteProduct_ShouldCallDeleteProductAsync_WhenProductExists()
        {
            ...
            _mockProductRepository.Setup(r => r.GetProductByIdAsync(productId)).ReturnsAsync(new Product(productId, "SampleType", "Sample Product", 100));
        ...
        public async Task GetProductById_ShouldReturnProduct_WhenProductExists()
        {
            ...
            var product = new Product(productId, "SampleType", "Sample Product", 100);
        ...
        public async Task GetProducts_ShouldReturnListOfProducts_WithLimitAndOffset()
        {
            ...
            {
                new Product(Guid.NewGuid(), "SampleType", "Sample Product 1", 100),
                new Product(Guid.NewGuid(), "SampleType", "Sample Product 2", 200),
                new Product(Guid.NewGuid(), "SampleType", "Sample Product 3", 300)
            };
